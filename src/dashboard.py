...
def get_prediction(cpu, ram, temp, latency):
    API_URL = os.environ.get("RENDER_API_URL", "https://axon-predictive-engine.onrender.com") + "/predict"
...
def report_false_positive(cpu, ram, temp, latency):
    API_URL = os.environ.get("RENDER_API_URL", "https://axon-predictive-engine.onrender.com") + "/feedback"
    payload = {
        "cpu": cpu,
        "ram": ram,
        "temp": temp,
...
def check_api_health():
    HEALTH_URL = os.environ.get("RENDER_API_URL", "https://axon-predictive-engine.onrender.com")
    try:
...
def get_history_data():
    HISTORY_URL = os.environ.get("RENDER_API_URL", "https://axon-predictive-engine.onrender.com") + "/history"
    try:
